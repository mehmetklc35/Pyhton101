...
def get_university_data(url):
    ...
    for row in rows:
        ...
        turkish_translation = translator.translate(university_data, src="en", dest="tr").text
...
def save_to_txt(data):
    with open("webometricks.txt", "w", encoding="utf-8") as file:
...
for url in urls:
    print(f"Universtiy data for {url}:")
